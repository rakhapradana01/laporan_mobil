...
<body>
    ...
    <div id="content-wrapper" class="d-flex flex-column mt-4 ">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
            <h1 class="h3 mb-4 text-gray-800">LAPORAN FILTER SERVICE </h1>
            <div class="card">
                <div class="card-body">
                    <?php
                    if ($_SESSION['fk_role'] == 'admin') {
                        echo '
                  <form target="_blank" action="' . BASE_URL . '/print/service.php" method="post">
                  <div class="row">
                        <label class="col-sm-3" for="">Jenis Service</label>
                    </div>
                    <div class="row">
                        <div class="col-sm-3">
                            <select name="service" class="form-control col" id="">
                                <option value="semua">Keseluruhan dan Mesin</option>
