            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <a href="<?= BASE_URL ?>/view/kembali/kembali.php"><button
                                        class="btn btn-danger">Kembali</button></a>
                                <hr>
                                <form action="<?= BASE_URL ?>/process/update/process_EditReserv.php" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="statusPinjam" class="form-control" required>
                                    ...
                                    ?>
                                    <input type="hidden" class="form-control" id="" aria-describedby="" name="id_reserv"
                                        value="<?= $data['id_reserv']; ?>" required>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Nik</label>
                                        <input type="text" class="form-control" disabled id="" aria-describedby=""
                                            name="Nik" value="<?= $data['Nik']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Tujuan</label>
                                        <input type="text" class="form-control" <?= $_SESSION['disabled'] ?> id=""
                                            aria-describedby="" name="Tujuan" value="<?= $data['Tujuan']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select name="Pilih_Reserv" class="form-control <?= $_SESSION['disabled'] ?>"
                                            required>
                                            <option value="<?= $data['Pilih_Reserv']; ?>" selected="selected">
                                                <?= $data['Pilih_Reserv']; ?>
                                            </option>
                                            <?php
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="hidden" class="form-control" id="Plat_nomer" aria-describedby=""
                                            value="<?= $data['plat_nomer']; ?>" name="id_mobil_user" required>
                                        <br>
                                        <select name="Plat_nomer" id="" class="form-control" <?= $_SESSION['disabled'] ?>
                                            required>
                                            <option value="<?= $data['plat_nomer']; ?>"><?= $data['plat_nomer']; ?>
                                            </option>
                                            <?php
                                    ...
                                    <input type="hidden" class="form-control" <?= $_SESSION['disabled'] ?> id=""
                                        aria-describedby="" name="WaktuOut" value="<?= $data['WaktuOut']; ?>">
                                    <input type="hidden" class="form-control" <?= $_SESSION['disabled2'] ?> id=""
                                        aria-describedby="" name="KmOut" value="<?= $data['KmOut']; ?>">
                                    <div class="mb-3">
                                        <label for="" class="form-label">Waktu Masuk</label>
                                        <input type="datetime-local" class="form-control" <?= $_SESSION['disabled2'] ?>
                                            id="waktu_in" aria-describedby="" name="WaktuIn"
                                            value="<?= $data['WaktuIn']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Km Masuk</label>
                                        <input type="text" class="form-control" <?= $_SESSION['disabled2'] ?> id=""
                                            aria-describedby="" name="KmIn" value="<?= $data['KmIn']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label">Foto Masuk</label>
                                        <input type="file" class="form-control" <?= $_SESSION['disabled2'] ?> id=""
                                            aria-describedby="" name="fotoin" value="<?= $data['fotoin']; ?>">
                                    </div>
                                    <div class="mb-3">
                                    </div>
                            </div>
