                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if ($_SESSION['fk_role'] == 'admin') {
                                            echo ' <td>
                                                <a href="updateperbaikan.php?id=' . $d["id"] . '"><button class="btn btn-success btn-sm"><i class="fas fa-fw fa-pen"></i></button></a>
                                                
                                                <a href="" data-id="' . $d["id"] . '" data-toggle="modal" data-target="#exampleModal" <button class="btn btn-danger btn-sm"> <i class="fas fa-fw fa-trash"></i></a>
                                            </td>';
                                        } else {
                                            echo '';
                                        }
                                        ...
                                        <td><?= $d['deskripsi']; ?></td>
                                        <td><?= $d['status']; ?></td>
                                        <td><?= isset($d['tgl']) ? date('d-m-Y H:i:s', strtotime($d['tgl'])) : "-"; ?></td>
                                    </tr>
                                <?php
                                };
                                ?>
