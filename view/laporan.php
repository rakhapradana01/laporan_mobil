...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
            <span style="margin: auto;  width: 22%;"><h2>LAPORAN DATA</h2></span>
        </div>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanMobil.php">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanreserv.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Reservasi
                                </div>
                                </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanperbaikan.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Perbaikan
                                </div>
                                </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanKelayakan.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Kelayakan
                                </div>
                                </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanAsuransi.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Asuransi
                                </div>
                                </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanPajak.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Pajak
                                </div>
                                </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanService.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Service
                                </div>
                                </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= BASE_URL ?>/view/laporan/laporanPegawai.php">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                    Laporan Pegawai
                                </div>
                                </a>
