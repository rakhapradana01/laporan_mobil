                ...
                <div class="card-body">
                    ...
                    <table id="myTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $data = mysqli_query($koneksi, "select * from pajak join mobil on pajak.plat_nomer=mobil.plat_nomer");
                            ...
                            ?>
                                <tr>
                                    ...
                                    if ($_SESSION['fk_role'] == 'admin') {
                                        echo ' <td>
                            <a href="updatepajak.php?id=' . $d["id"] . '"><button class="btn btn-success"><i class="fas fa-fw fa-pen"></i></button></a>
