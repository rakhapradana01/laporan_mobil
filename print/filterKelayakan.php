...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // $this->Cell(0, 5, '', 0, 1, 'l');
        // $this->Cell(0, 5, 'Laporan Ini Berisikan Data Mobil Operasional Berdasarkan mobil Pakai Kendaraannya Pada Kantor Administrasi Angkasa Pura Support', 0, 1, 'C');
        // $this->Ln(4); // Spasi
    }
...
if ($_POST['status'] == "semua") {
    if ($_POST['tipe'] == "semua" && $_POST['merek'] == "semua") {
        ...
        from
        kelayakan
        join kelayakan on mobil.plat_nomer=mobil.plat_nomer where mobil.tipe_mobil='$_POST[tipe]'";
    } else if ($_POST['tipe'] != "semua" && $_POST['merek'] != "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where mobil.tipe_mobil='$_POST[tipe]' and mobil.merek='$_POST[merek]'";
    } else if ($_POST['tipe'] == "semua" && $_POST['merek'] != "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where mobil.merek='$_POST[merek]'";
    }
    ...
    if ($_POST['tipe'] == "semua" && $_POST['merek'] == "semua") {
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='layak'";
    } else if ($_POST['tipe'] != "semua" && $_POST['merek'] == "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='layak' and mobil.tipe_mobil='$_POST[tipe]'";
    } else if ($_POST['tipe'] != "semua" && $_POST['merek'] != "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='layak' and mobil.tipe_mobil='$_POST[tipe]' and mobil.merek='$_POST[merek]'";
    } else if ($_POST['tipe'] == "semua" && $_POST['merek'] != "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='layak' and mobil.merek='$_POST[merek]'";
    }
} else {
    if ($_POST['tipe'] == "semua" && $_POST['merek'] == "semua") {
        $sql = "select 
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='pergantian'";
    } else if ($_POST['tipe'] != "semua" && $_POST['merek'] == "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='pergantian' and mobil.tipe_mobil='$_POST[tipe]'";
    } else if ($_POST['tipe'] != "semua" && $_POST['merek'] != "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='pergantian' and mobil.tipe_mobil='$_POST[tipe]' and mobil.merek='$_POST[merek]'";
    } else if ($_POST['tipe'] == "semua" && $_POST['merek'] != "semua") {
        $sql = "select 
        mobil.id,
        mobil.plat_nomer,
        ...
        from
        kelayakan
        join mobil on mobil.plat_nomer=mobil.plat_nomer where status='pergantian' and keyalakan.merek='$_POST[merek]'";
    }
}
