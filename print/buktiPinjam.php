...
// Menentukan judul surat berdasarkan Pilih_Reserv
$judul_surat = "SURAT DATA PEMINJAMAN MOBIL OPERASIONAL DI LUAR JAM OPERASIONAL"; // Default
if (trim($result['Pilih_Reserv']) == 'Dalam') {
    $judul_surat = "SURAT DATA PEMINJAMAN MOBIL OPERASIONAL DI DALAM JAM OPERASIONAL"; // Jika Pilih_Reserv = 'di dalam'
}

$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(0, 8, $judul_surat, 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->Ln(10);
$pdf->MultiCell(0, 7, 'Dengan ini menyatakan bahwa yang bersangkutan melakukan peminjaman kendaraan operasional, dengan tujuan dan informasi di atas. Surat ini dibuat sebagai bukti resmi peminjaman kendaraan dan wajib diserahkan kepada pihak berwenang saat diperlukan.');
...
// Hentikan output buffering sebelum mengakhiri
ob_end_clean();
$pdf->Output();
