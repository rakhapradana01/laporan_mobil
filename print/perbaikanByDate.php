...
$pdf->Cell(25, 10, 'plat nomer', 1);
$pdf->Cell(40, 10, 'Tujuan terakhir', 1);
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $pdf->Cell(10, 10, $no++, 1);
        $pdf->Cell(35, 10, $row['nama_pelapor'], 1);
        $pdf->Cell(15, 10, $row['Nik'], 1);
        $pdf->Cell(60, 10, $row['Devisi'], 1);
        $pdf->Cell(25, 10, $row['plat_nomer'], 1);
        $pdf->Cell(40, 10, $row['tujuan_terakhir'], 1);
        $pdf->Cell(40, 10, date('d-m-Y H:i:s', strtotime($row['tgl'])), 1);
        $pdf->Cell(50, 10, $row['deskripsi'], 1);
